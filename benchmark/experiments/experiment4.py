...
# Run fourth experiment: Semi-Supervised Learning, Balanced Dataset, with Base Query extension for DT, RF, GB
def run_experiment_4(query_set, datasets, datasets_onehot):

    print("----------------------------------------")
    print("Experiment 4: Semi-supervised Learning, Balanced Dataset, with Base Query extension")
    print("----------------------------------------")

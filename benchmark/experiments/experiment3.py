...
# Run third experiment: Supervised Learning, unbalanced Dataset, with Base Query extension for DT, RF, GB
def run_experiment_3(query_set, datasets, datasets_onehot):

    print("----------------------------------------")
    print("Experiment 3: Supervised Learning, Unbalanced Dataset, with Base Query extension")
    print("----------------------------------------")
